                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <table class="table table-condensed table-hover table-bordered mb-0">
                                            ...
                                            <tbody id="tbody_detail_advanced_purchases"></tbody>
                                        </table>
                                    </div>
                                </div>
                            </div>
    ...
    <script>
        ...
        function addProduct()
        {
            ...
            if(product_amount!='' && product_id!='' && product_quantity!='' && product_presentation_id!='')
            {
                ...
                $('#purchases_product_id, #emergency_mobile_id, #product_presentations_id').val(null).trigger('change');

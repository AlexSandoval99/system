...
@section('layout_js')
    <script>
            ...
            if(product_id!='' && product_quantity!='' && product_presentation_id!='')
            {
                if($.inArray(product_id, invoice_items_array) != '-1')
                {
                    if(confirm('Ya existe el producto, desea continuar?'))
                    {
                        ...
                        addToTable(product_id, description, product_quantity, product_presentation_id, product_presentation_name, '');
                    }
                    else
                    {
                        return false;
        ...
        function addToTable(id, name, quantity, presentation_id, presentation_name)
        {
            console.log('hola');
            counter++;

...
<body>
    ...
    <div class="border_with_padding">
        <table width="100%">
            ...
            <tr>               
                <td width="50%"><b>Fecha:</b> {{ $restocking->date->format('d/m/Y') }}</td>
                <td width="50%"><b>Fecha requerimiento:</b> {{ $restocking->date_requirement->format('d/m/Y') }}</td>
            </tr>
        </table>
    </div>    
    <br>
    ...
    <table width="100%" style="font-size:10px;">
        ...
        @foreach($restocking->restocking_details as $details)         

...
@section('title', 'Editar Pedido de Venta')
@section('content')
<div class="row">
    <div class="col-lg-12">
        <div class="ibox float-e-margins">
            {{ Form::open(['route' => ['wish-sales.update', $wish_sale->id], 'method' => 'PUT']) }}
            <div class="ibox-content">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-2">
                        <label>Fecha</label>
                        <input class="form-control" type="text" name="date" value="{{ old('date', $wish_sale->date) }}" readonly>
                        ...
                        <div class="ibox-content pb-0">
                            <div class="row">
                                <div class="form-group col-md-12">
                                    <label>Cliente</label>
                                    <input type="text" class="form-control" value="{{ $wish_sale->client ? $wish_sale->client->first_name.' '.$wish_sale->client->last_name . ' | ' . $wish_sale->client->ruc : '' }}" disabled>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="ibox-footer">
                ...
                <a href="{{ url('wish-sales') }}" class="btn btn-sm btn-danger">Cancelar</a>
            </div>
            {{ Form::close() }}
        </div>
    </div>
...
@section('layout_js')
    <script>
        ...
        {
            @foreach($wish_sale->wish_sale_details as $wishpro)

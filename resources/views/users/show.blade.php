    				...
    				<div class="col-md-12">
                        ...
                        <div class="col-lg-9">
                            <div class="attachment">
                                ...
                                @endforeach
                                <br><br>
                                <p class="help-block"><i class="fa fa-clock-o"></i> Creacion: {{$user->created_at->format('d/m/Y H:i') }}</p>
                                <p class="help-block"><i class="fa fa-refresh"></i> Actualizacion: {{$user->updated_at->format('d/m/Y H:i') }}</p>
                                <br>
